...
<html lang="en">
<head>
   <title>🤝SPARKS BANK®🤝-Honours Your Trust✔</title>
   <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="contactme.php">Contact Me</a>
        </li>
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>🤝SPARKS BANK®🤝-Honours Your Trust✔</h1>
      <p1> Welcome to SPARKS BANK®. It is one of leading private banks. SPARKS BANK® offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
